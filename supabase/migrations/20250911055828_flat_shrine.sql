...
INSERT INTO visitors (name, company, department, purpose, phone, email, host, check_in_time, status) VALUES
('John Doe', 'Tech Corp', 'IT-Infrastructure', 'Business Meeting', '+1234567890', 'john@techcorp.com', 'Alice Smith', '2024-01-15 09:30:00', 'checked-in'),
('Jane Wilson', 'Design Studio', 'Marketing', 'Interview', '+1234567891', 'jane@designstudio.com', 'Bob Johnson', '2024-01-15 10:15:00', 'checked-out'),
('Mike Brown', 'Consulting Inc', 'HR', 'Consultation', '+1234567892', 'mike@consulting.com', 'Carol Davis', '2024-01-15 11:00:00', 'checked-in');
