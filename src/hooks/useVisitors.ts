...
const convertApiVisitor = (apiVisitor: ApiVisitor): Visitor => ({
  ...
  appointmentWith: apiVisitor.appointmentWith,
  appointmentTime: apiVisitor.appointmentTime ? new Date(apiVisitor.appointmentTime) : undefined,
  hasElectronicDevices: apiVisitor.hasElectronicDevices,
  electronicDevicesList: apiVisitor.electronicDevicesList,
  idType: apiVisitor.idType as any,
  idNumber: apiVisitor.idNumber,
  idVerified: apiVisitor.idVerified,
